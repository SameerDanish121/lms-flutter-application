...
class ContestAttendanceScreen extends StatefulWidget {
  const ContestAttendanceScreen({super.key});

  @override
  _ContestAttendanceScreenState createState() =>
      _ContestAttendanceScreenState();
}

class _ContestAttendanceScreenState extends State<ContestAttendanceScreen> {

  List<dynamic> _contestedAttendances = [];
  bool _isLoading = true;
  bool _sortAscending = true;
  String _searchQuery = '';
  final String _apiUrl = "${ApiConfig.apiBaseUrl}Teachers/contest-list";
