...
import '../Home/today_classes.dart';
import '../Teacher_Home.dart';
class AttendanceUpdateScreen extends StatefulWidget {
  final ClassModel classRecord;
  const AttendanceUpdateScreen({super.key, required this.classRecord});
  @override
  State<AttendanceUpdateScreen> createState() => _AttendanceUpdateScreenState();
}
class _AttendanceUpdateScreenState extends State<AttendanceUpdateScreen> {
