...
import 'package:lmsv2/teacher/MarkAttendance/ReTakeOrUpdateAttendance.dart';
  ...
  static Future<void> showTodayClasses(BuildContext context, int teacherId) async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${ApiConfig.apiBaseUrl}Teachers/today?teacher_id=$teacherId'),
...
class _ClassCard extends StatelessWidget {
  ...
  void _navigateToAttendance(BuildContext context) {
    ...
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, __, ___) => AttendanceMarkingScreen(classRecord: classInfo),
  ...
  void _navigateToUpdateAttendance(BuildContext context) {
    ...
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, __, ___) => AttendanceUpdateScreen(classRecord: classInfo),
        transitionsBuilder: (_, animation, __, child) {
          return SlideTransition(
            position: Tween<Offset>(
              begin: const Offset(0, 0.1),
