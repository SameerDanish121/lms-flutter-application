...
class JuniorCreateCourseContentScreen extends StatefulWidget {
  final String teacherId;
  const JuniorCreateCourseContentScreen({Key? key, required this.teacherId}) : super(key: key);
  @override
  _JuniorCreateCourseContentScreenState createState() => _JuniorCreateCourseContentScreenState();
}
class _JuniorCreateCourseContentScreenState extends State<JuniorCreateCourseContentScreen> {
  ...
  Future<void> _fetchActiveCourses() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${ApiConfig.apiBaseUrl}JuniorLec/active/courses?teacher_id=${widget.teacherId}'),
      );
