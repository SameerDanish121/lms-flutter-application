...
class JuniorTaskDetailsScreen extends StatefulWidget {
  final int teacherId;

  const JuniorTaskDetailsScreen({Key? key, required this.teacherId}) : super(key: key);

  @override
  _JuniorTaskDetailsScreenState createState() => _JuniorTaskDetailsScreenState();
}

class _JuniorTaskDetailsScreenState extends State<JuniorTaskDetailsScreen> {
  final Dio _dio = Dio();
  ...
  Future<void> _fetchTasks() async {
    ...
    try {
      final response = await _dio.get(
        '${ApiConfig.apiBaseUrl}JuniorLec/task/get',
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildPerformancePill('🥇 Best', markingInfo['top']?['obtained_marks'], _completedColor),
              _buildPerformancePill('📊 Average', markingInfo['average']?['obtained_marks'], Colors.blue),
              _buildPerformancePill('⚠️ Worst', markingInfo['worst']?['obtained_marks'], Colors.orange),
            ],
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF4E6AEB),
        elevation: 0,
        centerTitle: true, // For better balance
        leading: IconButton(
        ...
        actions: [
          IconButton(
            ...
            padding: EdgeInsets.symmetric(horizontal: 12), // Better spacing
          ...
          PopupMenuButton<String>(
            ...
            padding: EdgeInsets.only(right: 8), // Adjust right padding
            constraints: BoxConstraints(), // Remove default button constraints
            itemBuilder: (context) => [
              PopupMenuItem(
                value: 'create',
                child: Row(
                  ...
                  children: [
                    Icon(Icons.add, color: Color(0xFF4E6AEB), size: 20),
                    SizedBox(width: 8),
                    Text('Create New Task', style: TextStyle(fontSize: 14)),
                  ],
                ),
              ),
            ],
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              // Wrap with a Container to provide better spacing
                              Container(
                                decoration: BoxDecoration(
                                ...
                                child: Column(
                                  children: [
                                    // Individual radio buttons stacked vertically for better readability
