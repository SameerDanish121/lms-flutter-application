...
import '../teacher/Home/Teacher_Main_Task.dart';
import 'package:lmsv2/teacher/course_content/teacher_course_content.dart';
import '../alerts/custom_alerts.dart';
import '../auth/login_screen.dart';
import 'Home/Junior_Main_CourseContent.dart';
import 'Home/Junior_Main_Home.dart';
import 'Home/Junior_Main_Profile.dart';
import 'Home/Junior_Main_Task.dart';
import 'Home/junior_Main_Notification.dart';
...
class _JuniorHomeState extends State<JuniorHome> {
  ...
  final List<Widget> _screens = [
    const JuniorHomeScreen(), //Done
    const JuniorCourseContent(),//Done
    const JuniorTaskScreen(),//Done
    const JuniorNotificationScreen(), //Done
    const JuniorProfileScreen(), //Done
  ];
  @override
