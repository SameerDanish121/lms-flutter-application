...
class JuniorAttendanceMarkingScreen extends StatefulWidget {
  final ClassModel classRecord;
  const JuniorAttendanceMarkingScreen({super.key, required this.classRecord});
  @override
  State<JuniorAttendanceMarkingScreen> createState() => _JuniorAttendanceMarkingScreenState();
}
class _JuniorAttendanceMarkingScreenState extends State<JuniorAttendanceMarkingScreen> {
  ...
  Future<void> _fetchAttendanceList() async {
    try {
      final response = await http.post(
        Uri.parse('${ApiConfig.apiBaseUrl}Teachers/attendance-list'),
