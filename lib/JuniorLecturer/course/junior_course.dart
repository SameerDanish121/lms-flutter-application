...
class JuniorCoursesScreen extends StatefulWidget {
  const JuniorCoursesScreen({super.key});

  @override
  _JuniorCoursesScreenState createState() => _JuniorCoursesScreenState();
}

class _JuniorCoursesScreenState extends State<JuniorCoursesScreen> {
  final String _apiUrl = "${ApiConfig.apiBaseUrl}JuniorLec/your-courses";
