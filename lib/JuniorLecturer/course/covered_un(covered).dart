...
class JuniorSectionDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> section;
  final String teacherId;
  const JuniorSectionDetailsScreen({
    Key? key,
    required this.section,
    required this.teacherId,
  }) : super(key: key);
  @override
  _JuniorSectionDetailsScreenState createState() => _JuniorSectionDetailsScreenState();
}

class _JuniorSectionDetailsScreenState extends State<JuniorSectionDetailsScreen> {
