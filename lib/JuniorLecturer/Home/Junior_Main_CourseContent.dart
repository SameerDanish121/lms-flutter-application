...
import '../course/covered_un(covered).dart';
import '../task/add_coursecontent_task.dart';
class JuniorCourseContent extends StatefulWidget {
  const JuniorCourseContent({Key? key}) : super(key: key);
  @override
  _JuniorCourseContentState createState() => _JuniorCourseContentState();
}

class _JuniorCourseContentState extends State<JuniorCourseContent> {
  ...
  Future<void> fetchCourseContent() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            '${ApiConfig.apiBaseUrl}JuniorLec/get_course_content?teacher_id=${teacherId}'),
  ...
  void _handleSectionClick(Map<dynamic, dynamic> section) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => JuniorSectionDetailsScreen(
                ...
                switch (value) {
                  ...
                  case 'create':
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            JuniorCreateCourseContentScreen(teacherId: teacherId),
                      ),
                    );
                    break;
                }
