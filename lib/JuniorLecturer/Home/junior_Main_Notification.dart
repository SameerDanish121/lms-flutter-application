...
class JuniorNotificationScreen extends StatefulWidget {
  const JuniorNotificationScreen({Key? key}) : super(key: key);
  @override
  State<JuniorNotificationScreen> createState() => _JuniorNotificationScreenState();
}

class _JuniorNotificationScreenState extends State<JuniorNotificationScreen>
  ...
  Future<void> _fetchNotifications() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
            '${ApiConfig.apiBaseUrl}JuniorLec/get/notifications?teacher_id=$teacherId'),
